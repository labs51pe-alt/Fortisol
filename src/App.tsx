        ...
        {isPromoOpen && (
          <div className="fixed inset-0 z-[300] flex items-center justify-center p-6">
            ...
            >
              <button 
                onClick={() => setIsPromoOpen(false)}
                className="absolute right-6 top-6 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-black shadow-lg transition-transform hover:scale-110 active:scale-90"
              >
                <X size={20} />
              </button>
              ...
              <div className="flex flex-col md:flex-row">
                {/* Content */}
                <div className="flex flex-1 flex-col justify-center p-10 md:p-14 text-black">
                  <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-slate-100 px-4 py-1.5 text-[9px] font-black uppercase tracking-[0.2em] text-black">
                    OFERTA EXCLUSIVA
                  </div>
                  <h2 className="text-4xl font-black leading-tight tracking-tighter uppercase mb-6 md:text-5xl">
                    SÚPER <br /> PROBIÓTICOS
                  </h2>
                  ...
                  <div className="flex flex-col gap-4 mt-8">
                    <button 
                      ...
                      className="w-full rounded-full border-2 border-black py-4 text-[11px] font-black text-black uppercase tracking-widest hover:bg-black hover:text-white transition-all"
                    >
                      VER MÁS
                    </button>
                    <button 
                      ...
                      className="w-full rounded-full bg-black py-5 text-[11px] font-black text-white uppercase tracking-widest shadow-xl shadow-black/20 hover:bg-slate-800 transition-all"
                    >
                      COMPRAR AHORA
                    </button>
                  </div>
                ...
                {/* Image & Badge */}
                <div className="relative flex flex-1 items-center justify-center bg-slate-50 p-10">
                  <img 
                    src="https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&q=80&w=800" 
                    alt="Promo Product" 
                    className="relative z-10 w-full drop-shadow-2xl transition-transform duration-700 hover:scale-110"
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute right-10 top-10 z-20 flex h-24 w-24 flex-col items-center justify-center rounded-full bg-red-500 text-white shadow-2xl ring-4 ring-white animate-bounce">
                    <p className="text-2xl font-black">-25%</p>
                    <p className="text-[10px] font-black uppercase tracking-widest">OFF</p>
                  </div>
                </div>
              </div>
            </motion.div>
